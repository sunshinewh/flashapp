...
urlpatterns = [
    ...
    #path('set_primary_image/', set_primary_image_view, name='set_primary_image_view'),
	...
	path('image-generation-test/', views.image_generation_test, name='image_generation_test'),
]
